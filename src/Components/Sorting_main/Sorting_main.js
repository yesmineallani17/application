    ...
    return (
      <div className="Sorting_main_container">
        <div className="sorting_me">
          <div className="Sorting_titre">City Guide > {categoryName} Sorting</div>
          <div className="sorting_rectangle1">
            <div className="icona">
              <img className="icona1" src="img/restaurant.png" />
            </div>
            <div className="titre_icona1">{categoryName}:</div>
            <Link to="/sorting">
              <button id="sorting_b" onClick={this.changeColor}>
                Sorting
              </button>
            </Link>
          </div>
          ...
          <div className="sorting_rectangle2">
            <Link to="/article">
              <button id="sorting_add" onClick={this.addChange}>
                Add
              </button>
            </Link>
          </div>
